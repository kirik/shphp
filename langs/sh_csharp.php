...
$sh_languages['csharp'] = array(
    ...
    array(
        ...
        array(
            '/\b[+-]?(?:(?:0x[a-f0-9]+)|(?:(?:[\d]*\.)?[\d]+(?:[eE][+-]?[\d]+)?))(?:[FfDdMmUulL]+)?\b/i',
            'sh_number',
            -1
        ),
        array(
        ...
        array(
            '/\b(?:bool|byte|sbyte|char|decimal|double|float|int|uint|long|ulong|object|short|ushort|string|void)\b/i',
            'sh_type',
            -1
        ),
        array(
